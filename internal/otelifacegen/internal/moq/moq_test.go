...
// expected.
// see https://github.com/ernado/example/internal/otelifacegen/issues/5
...
func TestMockGolden(t *testing.T) {
	cases := []struct {
	...
	}{
		{
			...
			// See https://github.com/ernado/example/internal/otelifacegen/issues/124
			name:       "SliceResult",
		...
		},
		{
			...
			// blank identifier.
			// See https://github.com/ernado/example/internal/otelifacegen/issues/70
			name:       "BlankID",
		...
		},
		{
			...
			// See https://github.com/ernado/example/internal/otelifacegen/issues/94
			name:       "PkgShadow",
...
func matchGoldenFile(goldenFile string, actual []byte) error {
	...
	// go test -v -run '^<Test-Name>$' github.com/ernado/example/internal/otelifacegen/internal/moq -update
	if *update {
...
func TestVendoredInterface(t *testing.T) {
	...
	incorrectImport := `"github.com/ernado/example/internal/otelifacegen/internal/moq/testpackages/vendoring/vendor/github.com/sudo-suhas/moq-test-pkgs/somerepo"`
...
// TestDotImports tests for https://github.com/ernado/example/internal/otelifacegen/issues/21.
...
func TestMockError(t *testing.T) {
	...
	cases := []struct {
		...
		},
		{
			name:     "UnexpectedType",
			namePair: "Person",
			wantErr:  "Person (github.com/ernado/example/internal/otelifacegen/internal/moq/testpackages/example.Person) is not an interface",
		},
	}
	for _, tc := range cases {
		t.Run(tc.name, func(t *testing.T) {
